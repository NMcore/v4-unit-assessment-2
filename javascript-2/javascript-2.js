...
const saleProducts = products.map(function(x) {
    let discount = x.price * 0.25
    x.price -= discount
    return x
});
// console.log(saleProducts)

// const saleProducts = products.map( x => x.price  * 0.25 );
// # .map()
// console.log(saleProducts)
////////////////////PROBLEM 3////////////////////
/*
...
//CODE HERE
//umm... this is correct
let blueProducts = saleProducts.filter((x, i) => {
        if (x.color.includes('blue')) {
            return products[i]
        }
    })
    //and this is correct
    // let blueProducts = saleProducts.filter(function(x, i) {
    //   if(x.color.includes('blue')){
    //     return products[i]
    //   }
    // });
...
//CODE HERE
let orderTotal = blueProducts.reduce((acc, x) => {
    return x.price + acc
}, 0);

//another format
// let orderTotal = blueProducts.reduce(function(acc, x) {
//   return x.price + acc
// }, 0)
...
person = {
        name: 'chelsey',
        age: 38,
        jobs: ['truck driver', 'hat maker', 'hair stylist', ],
        birthday: function() { this.age++ },
        favorites: { color: 'blue', number: 1, book: 'catcher in the rye' },
        kids: [{ name: 'emma', age: 6 }, { name: 'maddie', age: 4 }]
    }
    //////////////////////////////////PROBLEMS 13-14//////////////////////////////////
    /*
