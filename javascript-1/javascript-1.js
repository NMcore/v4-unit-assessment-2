...
//CODE HERE
var animals = [...forest, ...ocean, ...savannah, ...desert];
...
//CODE HERE
var animalsCopy = [...animals, 'elephant']
...
//CODE HERE
const compareNums = (num1, num2) => (num1 > num2 ? num1 : num2 > num1 ? num2 : num2 === num1 ? num2 : false);

// let compareNums = (num, num1) => {
//     if(num > num1) {
//         return num;
//     } else if(num1 > num) {
//         return num
...
////////////////////PROBLEM 6////////////////////
/*
    Write an arrow function called 'jsNinja' that returns the string: 'Nick likes Javascript'
*/
...
/*
    ...
    all online classes with no homework. #forin
*/

//CODE HERE
function checkLoop(classes) {
...
let pairsArray = []
    //DO NOT EDIT CODE ABOVE
    //CODE HERE
function matchMe(lettersToPair) {
...
var teachStay = teachTrick.bind(fido, 'stay')
    //Access the fido object and look at the tricks array to confirm this is working
...
//CODE HERE
let phone1 = new Phone('brandA', 'SuperA', 1, 'Black', false);

let phone2 = new Phone('brandB', 'SuperB', 2, 'Blue', false);

let phone3 = new Phone('brandG', 'SuperC', 3, 'Green', false);
